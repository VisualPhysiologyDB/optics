...
def process_sequence(sequence, selected_model):
    ...
    #try:
        #temp_dir = os.environ['GALAXY_JOB_TMP_DIR']  # Adapt if the environment variable is named differently
    #except KeyError:
    ...
    #Here from older version of code. 
    #cmd = "mafft --add /home/PIA/galaxy/tools/optics/temp_seq.fasta --keeplength /home/PIA/galaxy/tools/optics/data/whole_dataset.fasta > /home/PIA/galaxy/tools/optics/temp_ali.fasta"
    #cmd = cmd.split()
    ...
    #Below is from an oldeer version of the code.
    #try:
        #aligner = subprocess.Popen(cmd, stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
        #out_put = aligner.communicate()[0]
        #print(out_put)
        #error = aligner.communicate()[1]
