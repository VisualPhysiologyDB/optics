...
def process_sequence(mafft, sequence, selected_model, alignment_data):
...
def process_sequences_from_file(mafft,input_file,output_file,selected_model,alignment_dadta):
    if input_file == None:
    ...
    for seq in sequences:
        print(seq)
        prediction = process_sequence(mafft,seq,selected_model, alignment_dadta)  # Process each sequence
