...
try:
    ...
    # We don't exit here strictly, just warn, in case user only wants predictions
...
class ModeSelector(tk.Tk):
    """
    Startup dialog to select between Predictions and SHAP analysis.
    """
    def __init__(self):
        super().__init__()
...
class OpticsGUI(tk.Tk):
    def __init__(self, mode='predictions'):
        ...
        title_suffix = "Predictions" if mode == 'predictions' else "SHAP Analysis"
    ...
    def start_run_thread(self):
        ...
        log_txt = "Starting OPTICS Predictions..." if self.mode == 'predictions' else "Starting SHAP Analysis..."
