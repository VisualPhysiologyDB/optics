...
class AminoAcidPropertyEncoder(BaseEstimator, TransformerMixin):
    ...
    #} 
        aa_properties = { 
        'A': {'H1': 0.611, 'H2': -0.0938, 'H3': 0.5, 'V': 0.189, 'P1': 0.623, 'P2': 0.112, 'SASA': 0.443, 'NCI': -0.683, 'MASS': 0.382},
        'C': {'H1': 0.442, 'H2': -0.25, 'H3': 0.5, 'V': 0.307, 'P1': 0.423, 'P2': 0.313, 'SASA': 0.549, 'NCI': -1.0, 'MASS': 0.554},
        'D': {'H1': -0.166, 'H2': 1.0, 'H3': 1.0, 'V': 0.275, 'P1': 1.0, 'P2': 0.257, 'SASA': 0.596, 'NCI': -0.907, 'MASS': 0.618},
        'E': {'H1': -0.0844, 'H2': 1.0, 'H3': 1.0, 'V': 0.426, 'P1': 0.946, 'P2': 0.369, 'SASA': 0.699, 'NCI': -0.686, 'MASS': 0.693},
        'F': {'H1': 0.903, 'H2': -0.719, 'H3': 0.5, 'V': 0.794, 'P1': 0.4, 'P2': 0.709, 'SASA': 0.837, 'NCI': -0.463, 'MASS': 0.79}, 
        'G': {'H1': 0.54, 'H2': 0.0625, 'H3': 0.5, 'V': 0.0, 'P1': 0.692, 'P2': 0.0, 'SASA': 0.331, 'NCI': 0.562, 'MASS': 0.306},
        'H': {'H1': 0.0895, 'H2': -0.0938, 'H3': 1.0, 'V': 0.543, 'P1': 0.8, 'P2': 0.562, 'SASA': 0.76, 'NCI': -0.812, 'MASS': 0.736},
        'I': {'H1': 1.0, 'H2': -0.5, 'H3': 0.5, 'V': 0.643, 'P1': 0.4, 'P2': 0.455, 'SASA': 0.68, 'NCI': -0.578, 'MASS': 0.608},
        'K': {'H1': -0.473, 'H2': 1.0, 'H3': 0.5, 'V': 0.687, 'P1': 0.869, 'P2': 0.535, 'SASA': 0.848, 'NCI': -0.607, 'MASS': 0.688},
        'L': {'H1': 0.836, 'H2': -0.5, 'H3': 0.5, 'V': 0.643, 'P1': 0.377, 'P2': 0.455, 'SASA': 0.725, 'NCI': -0.361, 'MASS': 0.608},
        'M': {'H1': 0.621, 'H2': -0.344, 'H3': 0.5, 'V': 0.647, 'P1': 0.438, 'P2': 0.54, 'SASA': 0.764, 'NCI': -0.715, 'MASS': 0.705},
        'N': {'H1': -0.105, 'H2': 0.688, 'H3': 1.0, 'V': 0.403, 'P1': 0.892, 'P2': 0.328, 'SASA': 0.621, 'NCI': -0.696, 'MASS': 0.613},
        'P': {'H1': 0.355, 'H2': 0.0625, 'H3': 0.5, 'V': 0.288, 'P1': 0.615, 'P2': 0.32, 'SASA': 0.551, 'NCI': 1.0, 'MASS': 0.522},
        'Q': {'H1': -0.141, 'H2': 0.125, 'H3': 1.0, 'V': 0.555, 'P1': 0.808, 'P2': 0.44, 'SASA': 0.725, 'NCI': -0.378, 'MASS': 0.688},
        'R': {'H1': -1.0, 'H2': 1.0, 'H3': 1.0, 'V': 0.722, 'P1': 0.808, 'P2': 0.44, 'SASA': 0.725, 'NCI': -0.378, 'MASS': 0.839},
        'S': {'H1': 0.202, 'H2': 0.156, 'H3': 1.0, 'V': 0.201, 'P1': 0.708, 'P2': 0.152, 'SASA': 0.487, 'NCI': -0.701, 'MASS': 0.468},
        'T': {'H1': 0.269, 'H2': -0.0625, 'H3': 1.0, 'V': 0.353, 'P1': 0.662, 'P2': 0.264, 'SASA': 0.573, 'NCI': -0.711, 'MASS': 0.543},
        'V': {'H1': 0.847, 'H2': -0.406, 'H3': 0.5, 'V': 0.491, 'P1': 0.454, 'P2': 0.342, 'SASA': 0.618, 'NCI': -0.322, 'MASS': 0.532},
        'W': {'H1': 0.708, 'H2': -1.0, 'H3': 0.75, 'V': 1.0, 'P1': 0.415, 'P2': 1.0, 'SASA': 1.0, 'NCI': -0.46, 'MASS': 1.0},
        'Y': {'H1': 0.427, 'H2': -0.656, 'H3': 0.75, 'V': 0.806, 'P1': 0.477, 'P2': 0.729, 'SASA': 0.889, 'NCI': -0.564, 'MASS': 0.876},
        'GAP': {'H1': 0, 'H2': 0, 'H3': 0, 'V': 0, 'P1': 0, 'P2': 0, 'SASA': 0, 'NCI': 0, 'MASS': 0},
        '-':{'H1': 0, 'H2': 0, 'H3': 0, 'V': 0, 'P1': 0, 'P2': 0, 'SASA': 0, 'NCI': 0, 'MASS': 0},
        }
    ...
    def transform(self, X, y=None):
        result = pd.DataFrame(index=X.index)  # Initialize output

        for i, seq in X.iterrows():
            for j, aa in enumerate(seq):
                prefix = f"p{j+1}_"  # e.g., "p1_Hydrophobicity"
                #print(prefix)
                if aa in self.aa_properties: #Single amino acid
                    for prop_name, prop_value in self.aa_properties[aa].items():
                        result.loc[i, prefix + prop_name] = round(prop_value, 2)
                else:
                    aa_list = list(aa)
